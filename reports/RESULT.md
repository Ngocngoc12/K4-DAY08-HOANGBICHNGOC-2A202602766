...
|---|---------|--------|--------------|-----------|--------|-----------|---------------|----------------|
| 1 | Sinh viên UIT được mượn bao nhiêu sách tham khảo tối đa? | A | 0.000 | 0.000 | 0.000 | 0.000 | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) |
| 2 | Giảng viên UIT được mượn bao nhiêu giáo trình tối đa? | A | 0.000 | 0.000 | 0.000 | 0.000 | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) |
| 3 | Số tín chỉ chuyên ngành trong ngành Công nghệ Thông tin là bao nhiêu? | A | 0.000 | 0.000 | 0.000 | 0.000 | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) |
...
|------|---------|-------------|-------------|----------------------|
| 7 | Số tín chỉ chuyên ngành trong ngành Công nghệ Thông tin là bao nhiêu? | 0.000 | 0.000 | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) |
| 9 | Tỷ lệ phần trăm tín chỉ chuyên ngành trong tổng số là bao nhiêu? | 0.000 | 0.000 | retrieval: ngữ cảnh thiếu thông tin để trả lời (recall thấp) |
| 10 | Môn tốt nghiệp (T) là bao nhiêu tín chỉ? | 0.000 | 0.000 | generation: truy xuất được nhưng câu trả lời không khớp kỳ vọng |
| 11 | Sinh viên UIT được học bao nhiêu môn lý luận chính trị và pháp luật? | 0.000 | 0.000 | generation: câu trả lời mang thông tin ngoài ngữ cảnh (hallucination) |
| 16 | Tổng số tín chỉ kiến thức chuyên nghiệp là bao nhiêu? | 0.000 | 0.000 | generation: truy xuất được nhưng câu trả lời không khớp kỳ vọng |

## Recommendations

| Ưu tiên | Hành động | Bằng chứng từ phân tích lỗi | Tác động kỳ vọng |
|---------|-----------|----------------------------|-----------------|
| 1 | Cải thiện retrieval (recall thấp - thiếu ngữ cảnh) | 9/18 case lỗi | Giảm thiểu lỗi này |
| 1 | Cải thiện generation (trả lời không khớp kỳ vọng) | 4/18 case lỗi | Giảm thiểu lỗi này |
| 1 | Cải thiện retrieval (precision thấp - nhiều đoạn không liên quan) | 2/18 case lỗi | Giảm thiểu lỗi này |
| 1 | Cải thiện generation (hallucination) | 1/18 case lỗi | Giảm thiểu lỗi này |
